...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .product-title {
            margin: 0 0 0.75rem 0; font-size: 1.9rem; font-weight: 800; 
        ...
        .subtitle {
            color: #64748b; margin-bottom: 2rem; line-height: 1.6; 
            font-size: 1.05rem; text-align: center; font-weight: 500;
        }
        .price { 
            font-size: 2.8rem; color: #22c55e; font-weight: 900; 
        ...
        .btn-buy { 
            ...
            font-size: 1.2rem; border-radius: 16px; cursor: pointer; 
            width: 100%; font-weight: 700; transition: all 0.3s; 
            box-shadow: 0 10px 35px rgba(124,58,237,0.4);
            text-transform: uppercase; letter-spacing: 0.5px;
            margin: 1.5rem 0;
        }
        .btn-buy:hover:not(:disabled) { 
            transform: translateY(-3px); box-shadow: 0 15px 45px rgba(124,58,237,0.5); 
        }
        .btn-buy:disabled { background: #cbd5e1; cursor: not-allowed; transform: none; }
        .input { 
            width: 100%; padding: 18px; margin: 1rem 0; 
        ...
        .error { 
            ...
            color: #b91c1c; padding: 14px; border-radius: 14px; 
            margin-bottom: 1.5rem; font-size: 0.95rem; 
        }
        .secure { 
            display: flex; align-items: center; justify-content: center; 
            gap: 8px; margin-top: 2rem; color: #64748b; 
            font-size: 0.95rem; font-weight: 500;
            background: rgba(124,58,237,0.1); padding: 14px; 
            border-radius: 12px;
        }
        ...
        @media (max-width: 480px) {
            ...
            .btn-buy { padding: 22px 18px; font-size: 1.25rem; }
            .share-link { font-size: 0.75rem; }
            .share-link a { font-size: 0.7rem; padding: 3px 6px; }
        }
    </style>
</head>
<body>
